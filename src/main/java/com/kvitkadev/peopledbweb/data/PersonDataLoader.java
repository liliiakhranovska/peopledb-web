    ...
    public void run(ApplicationArguments args) throws Exception {
        if (personRepository.count() < 1) {
            List<Person> people = List.of(
                    ...
                    new Person(null, "Jenifer", "Smith", LocalDate.of(1960, 2, 1), "dummy@sample.com",  new BigDecimal("60000")),
                    new Person(null, "Jackson", "Snake", LocalDate.of(1970, 3, 1), "dummy@sample.com", new BigDecimal("70000")),
                    new Person(null, "Mark", "Snake", LocalDate.of(1980, 4, 1), "dummy@sample.com", new BigDecimal("80000")),
                    new Person(null, "Vishnu", "McGuire", LocalDate.of(1980, 4, 1), "dummy@sample.com", new BigDecimal("80000")),
